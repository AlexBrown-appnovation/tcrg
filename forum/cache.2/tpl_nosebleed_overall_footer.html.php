...
<div class="copyright"><?php if ($this->_rootref['U_ACP']) {  ?><a href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ACP'])) ? $this->_rootref['L_ACP'] : ((isset($user->lang['ACP'])) ? $user->lang['ACP'] : '{ ACP }')); ?></a><?php } ?></div>
	...
	<div class="copyright">
		...
		3.x port by <a href="http://www.countriesincolors.com/" target="_blank" title="Nosebleed template, updated by Countries in colors &copy; 2008">CiC</a> and <a href="http://www.willhough.net/" target="_willhough">will_hough</a> // b2
