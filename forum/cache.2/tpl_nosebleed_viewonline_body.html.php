<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('overall_header.html'); if ($this->_rootref['PAGINATION']) {  ?>
...
<table class="viewonline" width="100%" cellspacing="1">
<tr> 
	<td colspan="3"><h4><?php echo (isset($this->_rootref['TOTAL_REGISTERED_USERS_ONLINE'])) ? $this->_rootref['TOTAL_REGISTERED_USERS_ONLINE'] : ''; ?><br />
	<?php echo (isset($this->_rootref['TOTAL_GUEST_USERS_ONLINE'])) ? $this->_rootref['TOTAL_GUEST_USERS_ONLINE'] : ''; if ($this->_rootref['S_SWITCH_GUEST_DISPLAY']) {  ?> [ <a href="<?php echo (isset($this->_rootref['U_SWITCH_GUEST_DISPLAY'])) ? $this->_rootref['U_SWITCH_GUEST_DISPLAY'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SWITCH_GUEST_DISPLAY'])) ? $this->_rootref['L_SWITCH_GUEST_DISPLAY'] : ((isset($user->lang['SWITCH_GUEST_DISPLAY'])) ? $user->lang['SWITCH_GUEST_DISPLAY'] : '{ SWITCH_GUEST_DISPLAY }')); ?></a> ]<?php } ?></h4></td>
</tr>
<tr class="toplines">
...
<tr>
	<td class="row1 one"><p><?php echo $_user_row_val['USERNAME_FULL']; ?></p>
	<?php if ($_user_row_val['USER_IP']) {  ?><p><?php echo ((isset($this->_rootref['L_IP'])) ? $this->_rootref['L_IP'] : ((isset($user->lang['IP'])) ? $user->lang['IP'] : '{ IP }')); ?>: <a href="<?php echo $_user_row_val['U_USER_IP']; ?>"><?php echo $_user_row_val['USER_IP']; ?></a> &#187; <a href="<?php echo $_user_row_val['U_WHOIS']; ?>" onclick="popup(this.href, 750, 500); return false;"><?php echo ((isset($this->_rootref['L_WHOIS'])) ? $this->_rootref['L_WHOIS'] : ((isset($user->lang['WHOIS'])) ? $user->lang['WHOIS'] : '{ WHOIS }')); ?></a></p><?php } if ($_user_row_val['USER_BROWSER']) {  echo $_user_row_val['USER_BROWSER']; } ?></td>
	<td class="row2 two" align="center" nowrap="nowrap">&nbsp;<?php echo $_user_row_val['LASTUPDATE']; ?></td>
	<td class="row1 two"><a href="<?php echo $_user_row_val['U_FORUM_LOCATION']; ?>"><?php echo $_user_row_val['FORUM_LOCATION']; ?></a></td>
</tr>
<?php }} if ($this->_rootref['LEGEND']) {  ?>

<tr>
	<td class="row2 one" colspan="3"><?php echo ((isset($this->_rootref['L_LEGEND'])) ? $this->_rootref['L_LEGEND'] : ((isset($user->lang['LEGEND'])) ? $user->lang['LEGEND'] : '{ LEGEND }')); ?> : <?php echo (isset($this->_rootref['LEGEND'])) ? $this->_rootref['LEGEND'] : ''; ?></td>
</tr>
<?php } ?>
