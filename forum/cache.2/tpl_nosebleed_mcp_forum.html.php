<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('mcp_header.html'); if ($this->_rootref['S_MERGE_SELECT']) {  ?><div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;"><?php $this->_tpl_include('jumpbox.html'); ?></div><?php } if ($this->_rootref['U_VIEW_FORUM_LOGS']) {  ?><div class="right mainmenu"><a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM_LOGS'])) ? $this->_rootref['U_VIEW_FORUM_LOGS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_FORUM_LOGS'])) ? $this->_rootref['L_VIEW_FORUM_LOGS'] : ((isset($user->lang['VIEW_FORUM_LOGS'])) ? $user->lang['VIEW_FORUM_LOGS'] : '{ VIEW_FORUM_LOGS }')); ?></a></div><br /><?php } if ($this->_rootref['S_MERGE_SELECT']) {  ?><br clear="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" /><?php } ?>
...
<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; ?>
	...
	<tr>
		<td class="row1 pad4" width="25" align="center"><?php echo $_topicrow_val['TOPIC_FOLDER_IMG']; ?></td>
		<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?><!-- td class="row1 pad4" width="25" align="center"><?php echo $_topicrow_val['TOPIC_ICON_IMG']; ?></td --><?php } ?>

		<td class="row1 pad4">
			<?php if ($_topicrow_val['S_SELECT_TOPIC']) {  ?>

				[ <a href="<?php echo $_topicrow_val['U_SELECT_TOPIC']; ?>"><?php echo ((isset($this->_rootref['L_SELECT_MERGE'])) ? $this->_rootref['L_SELECT_MERGE'] : ((isset($user->lang['SELECT_MERGE'])) ? $user->lang['SELECT_MERGE'] : '{ SELECT_MERGE }')); ?></a> ]&nbsp;
			<?php } ?>

			<p><?php echo (isset($this->_rootref['NEWEST_POST_IMG'])) ? $this->_rootref['NEWEST_POST_IMG'] : ''; ?> <?php echo $_topicrow_val['ATTACH_ICON_IMG']; ?> <a href="<?php echo $_topicrow_val['U_VIEW_TOPIC']; ?>"><?php echo $_topicrow_val['TOPIC_TITLE']; ?></a>
		...
		<td class="row1 pad4" width="50" align="center"><p class="topicdetails"><?php echo $_topicrow_val['REPLIES']; ?></p></td>
		<td class="row1 pad4" width="120" align="center"><p class="topicdetails"><?php echo $_topicrow_val['LAST_POST_TIME']; ?></p></td>
		<td class="row2 pad4" align="center">
...
<?php }} else { ?>
	...
	<tr>
		<td class="row1 pad4" colspan="8" align="center"><p><?php echo ((isset($this->_rootref['L_NO_TOPICS'])) ? $this->_rootref['L_NO_TOPICS'] : ((isset($user->lang['NO_TOPICS'])) ? $user->lang['NO_TOPICS'] : '{ NO_TOPICS }')); ?></p></td>
	</tr>
<?php } if (! $this->_rootref['S_MERGE_SELECT']) {  ?>

<tr>
	<td class="row3 pad4" colspan="6" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>">
		<select name="action">
		...
		<input class="button" type="submit" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" />
	</td>
</tr>
<?php } ?>
