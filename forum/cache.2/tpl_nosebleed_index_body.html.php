...
<div class="timezone left">This data is <?php echo ((isset($this->_rootref['L_ONLINE_EXPLAIN'])) ? $this->_rootref['L_ONLINE_EXPLAIN'] : ((isset($user->lang['ONLINE_EXPLAIN'])) ? $user->lang['ONLINE_EXPLAIN'] : '{ ONLINE_EXPLAIN }')); ?></div>
<?php } if (! $this->_rootref['S_USER_LOGGED_IN']) {  ?>
...
<table cellspacing="1" class="index_body_icons">
	<tr> 
		<td><?php echo (isset($this->_rootref['FORUM_NEW_IMG'])) ? $this->_rootref['FORUM_NEW_IMG'] : ''; ?>
