...
<?php if ($this->_rootref['S_SHOW_PM_BOX'] && $this->_rootref['S_POST_ACTION']) {  ?>
	...
	<?php } else { ?>
		...
		<tr>
			<td class="row2 pad4"><textarea class="post" name="username_list" rows="5" cols="22"></textarea><br />
	...
	<?php } if ($this->_rootref['S_GROUP_OPTIONS']) {  ?>
		...
		<tr>
			<td class="row2 pad4"><select name="group_list[]" multiple="true" size="5" style="width:150px"><?php echo (isset($this->_rootref['S_GROUP_OPTIONS'])) ? $this->_rootref['S_GROUP_OPTIONS'] : ''; ?></select></td>
		</tr>
	<?php } if ($this->_rootref['S_ALLOW_MASS_PM']) {  ?>
