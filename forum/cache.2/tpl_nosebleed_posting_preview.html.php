...
<tr> 
	<td colspan="2"><h2><?php echo ((isset($this->_rootref['L_PREVIEW'])) ? $this->_rootref['L_PREVIEW'] : ((isset($user->lang['PREVIEW'])) ? $user->lang['PREVIEW'] : '{ PREVIEW }')); ?></h2></td>
</tr>
<tr>
	<td class="row1 pad4" width="22%">&nbsp;</td>
	<td class="row2 pad4"><?php echo (isset($this->_rootref['MINI_POST_IMG'])) ? $this->_rootref['MINI_POST_IMG'] : ''; echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>: <?php echo (isset($this->_rootref['POST_DATE'])) ? $this->_rootref['POST_DATE'] : ''; ?> &nbsp;&nbsp;&nbsp; <?php echo ((isset($this->_rootref['L_POST_SUBJECT'])) ? $this->_rootref['L_POST_SUBJECT'] : ((isset($user->lang['POST_SUBJECT'])) ? $user->lang['POST_SUBJECT'] : '{ POST_SUBJECT }')); ?>: <?php echo (isset($this->_rootref['PREVIEW_SUBJECT'])) ? $this->_rootref['PREVIEW_SUBJECT'] : ''; ?></td>
</tr>
<?php if ($this->_rootref['S_HAS_POLL_OPTIONS']) {  ?>

<tr>
	<td class="row1 pad4" width="22%">&nbsp;</td>
	<td class="row2 pad4" colspan="2" align="center"><br clear="all" />
...
<tr> 
	<td class="row1 six" width="22%">&nbsp;</td>
	<td class="row2 seven">
		<table class="posting_body" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="row2 seven"><div><?php echo (isset($this->_rootref['PREVIEW_MESSAGE'])) ? $this->_rootref['PREVIEW_MESSAGE'] : ''; ?></div>
			...
			<?php } if ($this->_rootref['PREVIEW_SIGNATURE']) {  ?><br />_________________<br /><?php echo (isset($this->_rootref['PREVIEW_SIGNATURE'])) ? $this->_rootref['PREVIEW_SIGNATURE'] : ''; } ?></td>
		</tr>
		</table>
	</td>
</tr>
