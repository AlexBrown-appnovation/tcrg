...
<?php if (( $this->_rootref['S_SHOW_PM_BOX'] || $this->_rootref['S_EDIT_POST'] ) && $this->_rootref['S_POST_ACTION']) {  echo (isset($this->_rootref['S_FORM_TOKEN'])) ? $this->_rootref['S_FORM_TOKEN'] : ''; ?></form><?php } $this->_tpl_include('breadcrumbs.html'); ?>
