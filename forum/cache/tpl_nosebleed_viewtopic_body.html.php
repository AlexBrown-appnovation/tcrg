...
<table cellspacing="1" class="viewtopic">
	...
	<tr>
		<td colspan="2"><h2><?php echo ((isset($this->_rootref['L_FORUM_RULES'])) ? $this->_rootref['L_FORUM_RULES'] : ((isset($user->lang['FORUM_RULES'])) ? $user->lang['FORUM_RULES'] : '{ FORUM_RULES }')); ?></h2></td>
	</tr>
	<tr>
...
<?php } $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } if ($_postrow_val['S_IGNORE_POST']) {  ?>
	...
	<?php } else { ?>
		...
		<tr>
			<?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><td class="row1 three"><?php } else { ?><td class="row2 three"><?php } if ($_postrow_val['POSTER_AVATAR']) {  ?><span class="avatar"><?php echo $_postrow_val['POSTER_AVATAR']; ?></span><?php } if ($_postrow_val['RANK_TITLE']) {  ?><span class="block"><?php echo $_postrow_val['RANK_TITLE']; ?></span><?php } if ($_postrow_val['RANK_IMG']) {  ?><span class="block"><?php echo $_postrow_val['RANK_IMG']; ?></span><?php } if ($_postrow_val['POSTER_POSTS'] != ('')) {  ?><span class="block"><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?>: <?php echo $_postrow_val['POSTER_POSTS']; ?></span><?php } if ($_postrow_val['POSTER_FROM']) {  ?><span class="block"><?php echo ((isset($this->_rootref['L_LOCATION'])) ? $this->_rootref['L_LOCATION'] : ((isset($user->lang['LOCATION'])) ? $user->lang['LOCATION'] : '{ LOCATION }')); ?>: <?php echo $_postrow_val['POSTER_FROM']; ?></span><?php } if ($_postrow_val['POSTER_JOINED']) {  ?><span class="block"><?php echo ((isset($this->_rootref['L_JOINED'])) ? $this->_rootref['L_JOINED'] : ((isset($user->lang['JOINED'])) ? $user->lang['JOINED'] : '{ JOINED }')); ?>: <?php echo $_postrow_val['POSTER_JOINED']; ?></span><?php } $_custom_fields_count = (isset($_postrow_val['custom_fields'])) ? sizeof($_postrow_val['custom_fields']) : 0;if ($_custom_fields_count) {for ($_custom_fields_i = 0; $_custom_fields_i < $_custom_fields_count; ++$_custom_fields_i){$_custom_fields_val = &$_postrow_val['custom_fields'][$_custom_fields_i]; ?><span class="block"><?php echo $_custom_fields_val['PROFILE_FIELD_NAME']; ?>:</b> <?php echo $_custom_fields_val['PROFILE_FIELD_VALUE']; ?></span><?php }} ?>
			</td>
		...
		<tr> 
			...
			<?php } else { ?>
			<td class="row2 six">
			<?php } if (! $this->_rootref['S_IS_BOT']) {  if ($_postrow_val['ONLINE_IMG']) {  echo $_postrow_val['ONLINE_IMG']; ?> <?php } if ($_postrow_val['U_PROFILE']) {  ?><a href="<?php echo $_postrow_val['U_PROFILE']; ?>"><?php echo (isset($this->_rootref['PROFILE_IMG'])) ? $this->_rootref['PROFILE_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_PM']) {  ?><a href="<?php echo $_postrow_val['U_PM']; ?>"><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_EMAIL']) {  ?><a href="<?php echo $_postrow_val['U_EMAIL']; ?>"><?php echo (isset($this->_rootref['EMAIL_IMG'])) ? $this->_rootref['EMAIL_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_WWW']) {  ?><a href="<?php echo $_postrow_val['U_WWW']; ?>" title="<?php echo ((isset($this->_rootref['L_VISIT_WEBSITE'])) ? $this->_rootref['L_VISIT_WEBSITE'] : ((isset($user->lang['VISIT_WEBSITE'])) ? $user->lang['VISIT_WEBSITE'] : '{ VISIT_WEBSITE }')); ?>: <?php echo $_postrow_val['U_WWW']; ?>"><?php echo (isset($this->_rootref['WWW_IMG'])) ? $this->_rootref['WWW_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_MSN']) {  ?><a href="<?php echo $_postrow_val['U_MSN']; ?>" onclick="popup(this.href, 550, 320); return false;" title="<?php echo ((isset($this->_rootref['L_MSNM'])) ? $this->_rootref['L_MSNM'] : ((isset($user->lang['MSNM'])) ? $user->lang['MSNM'] : '{ MSNM }')); ?>"><?php echo (isset($this->_rootref['MSN_IMG'])) ? $this->_rootref['MSN_IMG'] : ''; ?></a> <?php } else if ($this->_rootref['USER_MSN']) {  echo (isset($this->_rootref['USER_MSN'])) ? $this->_rootref['USER_MSN'] : ''; ?> <?php } if ($_postrow_val['U_ICQ']) {  ?><a href="<?php echo $_postrow_val['U_ICQ']; ?>" onclick="popup(this.href, 550, 320); return false;" title="<?php echo ((isset($this->_rootref['L_ICQ'])) ? $this->_rootref['L_ICQ'] : ((isset($user->lang['ICQ'])) ? $user->lang['ICQ'] : '{ ICQ }')); ?>"><?php echo (isset($this->_rootref['ICQ_IMG'])) ? $this->_rootref['ICQ_IMG'] : ''; ?></a> <?php } else if ($this->_rootref['USER_ICQ']) {  echo (isset($this->_rootref['USER_ICQ'])) ? $this->_rootref['USER_ICQ'] : ''; ?> <?php } if ($_postrow_val['U_YIM']) {  ?><a href="<?php echo $_postrow_val['U_YIM']; ?>" onclick="popup(this.href, 780, 550); return false;" title="<?php echo ((isset($this->_rootref['L_YIM'])) ? $this->_rootref['L_YIM'] : ((isset($user->lang['YIM'])) ? $user->lang['YIM'] : '{ YIM }')); ?>"><?php echo (isset($this->_rootref['YIM_IMG'])) ? $this->_rootref['YIM_IMG'] : ''; ?></a> <?php } else if ($this->_rootref['USER_YIM']) {  echo (isset($this->_rootref['USER_YIM'])) ? $this->_rootref['USER_YIM'] : ''; } if ($_postrow_val['U_AIM']) {  ?><a href="<?php echo $_postrow_val['U_AIM']; ?>" onclick="popup(this.href, 550, 320); return false;" title="<?php echo ((isset($this->_rootref['L_AIM'])) ? $this->_rootref['L_AIM'] : ((isset($user->lang['AIM'])) ? $user->lang['AIM'] : '{ AIM }')); ?>"><?php echo (isset($this->_rootref['AIM_IMG'])) ? $this->_rootref['AIM_IMG'] : ''; ?></a> <?php } else if ($this->_rootref['USER_AIM']) {  echo (isset($this->_rootref['USER_AIM'])) ? $this->_rootref['USER_AIM'] : ''; ?> <?php } if ($_postrow_val['U_JABBER']) {  ?><a href="<?php echo $_postrow_val['U_JABBER']; ?>" onclick="popup(this.href, 550, 320); return false;" title="<?php echo ((isset($this->_rootref['L_JABBER'])) ? $this->_rootref['L_JABBER'] : ((isset($user->lang['JABBER'])) ? $user->lang['JABBER'] : '{ JABBER }')); ?>"><?php echo (isset($this->_rootref['JABBER_IMG'])) ? $this->_rootref['JABBER_IMG'] : ''; ?></a><?php } else if ($this->_rootref['USER_JABBER']) {  echo (isset($this->_rootref['USER_JABBER_IMG'])) ? $this->_rootref['USER_JABBER_IMG'] : ''; } } ?>
			</td>
		</tr>
