<?php if (!defined('IN_PHPBB')) exit; ?><table class="posting_body" width="100%" cellspacing="1">
<tr>
	<th><h2><?php echo ((isset($this->_rootref['L_POST_REVIEW'])) ? $this->_rootref['L_POST_REVIEW'] : ((isset($user->lang['POST_REVIEW'])) ? $user->lang['POST_REVIEW'] : '{ POST_REVIEW }')); ?></h2></th>
</tr>
<tr>
	<td class="row1 pad25" align="center"><?php echo ((isset($this->_rootref['L_POST_REVIEW_EXPLAIN'])) ? $this->_rootref['L_POST_REVIEW_EXPLAIN'] : ((isset($user->lang['POST_REVIEW_EXPLAIN'])) ? $user->lang['POST_REVIEW_EXPLAIN'] : '{ POST_REVIEW_EXPLAIN }')); ?></td>
</tr>
<tr>
	...
	<td class="row1">
		...
		<?php $_post_review_row_count = (isset($this->_tpldata['post_review_row'])) ? sizeof($this->_tpldata['post_review_row']) : 0;if ($_post_review_row_count) {for ($_post_review_row_i = 0; $_post_review_row_i < $_post_review_row_count; ++$_post_review_row_i){$_post_review_row_val = &$this->_tpldata['post_review_row'][$_post_review_row_i]; ?>
			...
			<tr>
				...
				<?php if (!($_post_review_row_val['S_ROW_COUNT'] & 1)  ) {  ?><td class="row1 three" rowspan="2" valign="top"><?php } else { ?><td class="row2 three" rowspan="2" valign="top"><?php } ?><!-- **********************NOT YET TESTED FROM HERE NEW SINCE PHP 3.0.5 --><?php if ($_post_review_row_val['S_IGNORE_POST']) {  ?>

				<?php echo $_post_review_row_val['L_IGNORE_POST']; ?>

				</td>
				<?php } else { ?>

				<a id="pr<?php echo $_post_review_row_val['POST_ID']; ?>"></a>
					<table width="150" cellspacing="0">
					<tr>
						<td><b><?php echo $_post_review_row_val['POST_AUTHOR_FULL']; ?></b></td>
					</tr>
					</table>
				</td>
				<?php } ?><!-- **********************NOT YET TESTED UNTIL HERE -->
				<td class="row3 two" width="100%">
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td>&nbsp;</td>
						<td valign="middle" nowrap="nowrap"><b><?php echo ((isset($this->_rootref['L_POST_SUBJECT'])) ? $this->_rootref['L_POST_SUBJECT'] : ((isset($user->lang['POST_SUBJECT'])) ? $user->lang['POST_SUBJECT'] : '{ POST_SUBJECT }')); ?>:</b>&nbsp;</td>
						<td width="100%" valign="middle"><?php echo $_post_review_row_val['POST_SUBJECT']; ?></td>
						<td>&nbsp;</td>
					</tr>
					</table>
				</td>
			...
			<tr>
				...
				<?php if (!($_post_review_row_val['S_ROW_COUNT'] & 1)  ) {  ?><td class="row1 three" valign="top"><?php } else { ?><td class="row2 three" valign="top"><?php } ?>
...
<!-- **********************NOT YET TESTED FROM HERE --><?php if ($_post_review_row_val['S_HAS_ATTACHMENTS']) {  ?>
