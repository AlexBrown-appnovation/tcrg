<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
	...
	<?php } else { if ($__file_val['S_THUMBNAIL']) {  ?>
		...
		<dl class="thumbnail">
			<dt><a rel="rokbox(rokalbum)[<?php echo $__file_val['WIDTH']; ?> <?php echo $__file_val['HEIGHT']; ?>]" title="<?php echo $__file_val['COMMENT']; ?> :: <?php echo $__file_val['DOWNLOAD_NAME']; ?> (<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>) <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?>" href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>/rokbox.jpg"><img src="<?php echo $__file_val['THUMB_IMAGE']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" title="<?php echo $__file_val['DOWNLOAD_NAME']; ?> (<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>) <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?>" /></a></dt>			
