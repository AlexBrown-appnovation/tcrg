<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
		...
		[<?php echo $__file_val['DENIED_MESSAGE']; ?>]<br />
	<?php } else { if ($__file_val['COMMENT']) {  ?>

			<?php echo ((isset($this->_rootref['L_FILE_COMMENT'])) ? $this->_rootref['L_FILE_COMMENT'] : ((isset($user->lang['FILE_COMMENT'])) ? $user->lang['FILE_COMMENT'] : '{ FILE_COMMENT }')); ?>: <?php echo $__file_val['COMMENT']; ?><br />
		<?php } if ($__file_val['S_THUMBNAIL']) {  ?>

			<a href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>"><img src="<?php echo $__file_val['THUMB_IMAGE']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" /></a><br />
			<?php echo $__file_val['DOWNLOAD_NAME']; ?> [ <?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?> | <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?> ]<br />
		<?php } if ($__file_val['S_IMAGE']) {  ?>

			<img src="<?php echo $__file_val['U_INLINE_LINK']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" /><br />
			<?php echo $__file_val['DOWNLOAD_NAME']; ?> [ <?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?> | <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?> ]<br />
		<?php } if ($__file_val['S_FILE']) {  if ($__file_val['UPLOAD_ICON']) {  echo $__file_val['UPLOAD_ICON']; ?> <?php } ?>

			<a href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>"><?php echo $__file_val['DOWNLOAD_NAME']; ?></a> [<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>]
			<br />
			<?php echo $__file_val['L_DOWNLOAD_COUNT']; ?><br />
		<?php } ?><!-- **********************TO BE VERIFIED FOR COMPATIBILITY FROM HERE --><?php if ($__file_val['S_WM_FILE']) {  ?><!-- method used here from http://alistapart.com/articles/byebyeembed / autosizing seems to not work always, this will not fix -->
		...
		<?php } else if ($__file_val['S_FLASH_FILE']) {  ?>
			...
			<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" codebase="http://active.macromedia.com/flash2/cabs/swflash.cab#version=5,0,0,0" width="<?php echo $__file_val['WIDTH']; ?>" height="<?php echo $__file_val['HEIGHT']; ?>">
				<param name="movie" value="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>" />
				<param name="play" value="true" />
				<param name="loop" value="true" />
				<param name="quality" value="high" />
				<param name="allowScriptAccess" value="never" />
				<param name="allowNetworking" value="internal" />
        			    <embed src="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="<?php echo $__file_val['WIDTH']; ?>" height="<?php echo $__file_val['HEIGHT']; ?>" play="true" loop="true" quality="high" allowscriptaccess="never" allownetworking="internal"></embed>
			</object>
		<?php } else if ($__file_val['S_QUICKTIME_FILE']) {  ?>
			...
			<object id="qtstream_<?php echo $__file_val['ATTACH_ID']; ?>" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab#version=6,0,2,0" width="0" height="16">
				...
				<embed name="qtstream_<?php echo $__file_val['ATTACH_ID']; ?>" src="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>" pluginspage="http://www.apple.com/quicktime/download/" enablejavascript="true" controller="true" width="0" height="16" type="video/quicktime" autoplay="false"> 
			</object>
		...
		<?php } if ($__file_val['S_WM_FILE'] || $__file_val['S_RM_FILE'] || $__file_val['S_FLASH_FILE'] || $__file_val['S_QUICKTIME_FILE']) {  ?>
			...
			<span class="gensmall"><a href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>"><?php echo $__file_val['DOWNLOAD_NAME']; ?></a> [ <?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?> | <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?> ]</span>
		<?php } ?><!-- **********************TO BE VERIFIED FOR COMPATIBILITY UNTIL HERE -->
		<br />
	<?php } }} ?>