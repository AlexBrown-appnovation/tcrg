<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('ucp_header.html'); $this->_tpldata['DEFINE']['.']['S_SIGNATURE'] = 1; ?>

<table class="viewforum" width="100%" cellspacing="1">
<tr>
	<th colspan="2"><h2><?php echo ((isset($this->_rootref['L_TITLE'])) ? $this->_rootref['L_TITLE'] : ((isset($user->lang['TITLE'])) ? $user->lang['TITLE'] : '{ TITLE }')); ?></h2></th>
</tr>
<tr>
	<td colspan="2" class="row1 pad4"><?php echo ((isset($this->_rootref['L_SIGNATURE_EXPLAIN'])) ? $this->_rootref['L_SIGNATURE_EXPLAIN'] : ((isset($user->lang['SIGNATURE_EXPLAIN'])) ? $user->lang['SIGNATURE_EXPLAIN'] : '{ SIGNATURE_EXPLAIN }')); ?></td>
</tr>
...
<tr>
	<td colspan="2" class="row2 two">
		...
		<tr>
			<td colspan="2"><textarea class="post" name="signature" rows="10" cols="76" style="width: 99%;" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);"><?php echo (isset($this->_rootref['SIGNATURE'])) ? $this->_rootref['SIGNATURE'] : ''; ?></textarea></td>
		</tr>
...
<tr>
	<td class="row1 pad4" valign="top"><b><?php echo ((isset($this->_rootref['L_OPTIONS'])) ? $this->_rootref['L_OPTIONS'] : ((isset($user->lang['OPTIONS'])) ? $user->lang['OPTIONS'] : '{ OPTIONS }')); ?></b><br />
		<table cellspacing="2" cellpadding="0" border="0">
		<tr>
			<td><?php echo (isset($this->_rootref['BBCODE_STATUS'])) ? $this->_rootref['BBCODE_STATUS'] : ''; ?></td>
		</tr>
		<tr>
			<td><?php echo (isset($this->_rootref['IMG_STATUS'])) ? $this->_rootref['IMG_STATUS'] : ''; ?></td>
		</tr>
		<tr>
			<td><?php echo (isset($this->_rootref['FLASH_STATUS'])) ? $this->_rootref['FLASH_STATUS'] : ''; ?></td>
		</tr>
		<tr>
			<td><?php echo (isset($this->_rootref['URL_STATUS'])) ? $this->_rootref['URL_STATUS'] : ''; ?></td>
		</tr>
		<tr>
			<td><?php echo (isset($this->_rootref['SMILIES_STATUS'])) ? $this->_rootref['SMILIES_STATUS'] : ''; ?></td>
		</tr>
		</table>
	</td>
	<td class="row2 pad4" valign="top">
...
<?php if ($this->_rootref['SIGNATURE_PREVIEW']) {  ?>
	...
	<tr>
		<th colspan="2" valign="middle"><h2><?php echo ((isset($this->_rootref['L_SIGNATURE_PREVIEW'])) ? $this->_rootref['L_SIGNATURE_PREVIEW'] : ((isset($user->lang['SIGNATURE_PREVIEW'])) ? $user->lang['SIGNATURE_PREVIEW'] : '{ SIGNATURE_PREVIEW }')); ?></h2></th>
	</tr>
	<tr> 
...
<tr>
	<td class="row3 txtmiddle pad4" colspan="2"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?><input class="button" type="submit" name="preview" value="<?php echo ((isset($this->_rootref['L_PREVIEW'])) ? $this->_rootref['L_PREVIEW'] : ((isset($user->lang['PREVIEW'])) ? $user->lang['PREVIEW'] : '{ PREVIEW }')); ?>" />&nbsp;&nbsp;<input class="button" type="submit" name="submit" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" />&nbsp;&nbsp;<input class="button" type="reset" value="<?php echo ((isset($this->_rootref['L_RESET'])) ? $this->_rootref['L_RESET'] : ((isset($user->lang['RESET'])) ? $user->lang['RESET'] : '{ RESET }')); ?>" name="reset" /></td>
</tr>
</table>
