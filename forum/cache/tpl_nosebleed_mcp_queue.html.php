...
<tr>
	<th colspan="4" nowrap="nowrap"><h2><?php echo ((isset($this->_rootref['L_DISPLAY_OPTIONS'])) ? $this->_rootref['L_DISPLAY_OPTIONS'] : ((isset($user->lang['DISPLAY_OPTIONS'])) ? $user->lang['DISPLAY_OPTIONS'] : '{ DISPLAY_OPTIONS }')); ?></h2></th>
</tr>
<tr>
	<td colspan="4" class="row3 pad4"><?php echo ((isset($this->_rootref['L_DISPLAY_ITEMS'])) ? $this->_rootref['L_DISPLAY_ITEMS'] : ((isset($user->lang['DISPLAY_ITEMS'])) ? $user->lang['DISPLAY_ITEMS'] : '{ DISPLAY_ITEMS }')); ?>: <?php echo (isset($this->_rootref['S_SELECT_SORT_DAYS'])) ? $this->_rootref['S_SELECT_SORT_DAYS'] : ''; ?>&nbsp;<?php echo ((isset($this->_rootref['L_SORT_BY'])) ? $this->_rootref['L_SORT_BY'] : ((isset($user->lang['SORT_BY'])) ? $user->lang['SORT_BY'] : '{ SORT_BY }')); ?> <?php echo (isset($this->_rootref['S_SELECT_SORT_KEY'])) ? $this->_rootref['S_SELECT_SORT_KEY'] : ''; ?> <?php echo (isset($this->_rootref['S_SELECT_SORT_DIR'])) ? $this->_rootref['S_SELECT_SORT_DIR'] : ''; ?>&nbsp;<?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?> <select name="f"><?php echo (isset($this->_rootref['S_FORUM_OPTIONS'])) ? $this->_rootref['S_FORUM_OPTIONS'] : ''; ?></select> &nbsp; <?php if ($this->_rootref['TOPIC_ID']) {  ?><input type="checkbox" class="radio" name="t" value="<?php echo (isset($this->_rootref['TOPIC_ID'])) ? $this->_rootref['TOPIC_ID'] : ''; ?>" checked="checked" />&nbsp; <b><?php echo ((isset($this->_rootref['L_ONLY_TOPIC'])) ? $this->_rootref['L_ONLY_TOPIC'] : ((isset($user->lang['ONLY_TOPIC'])) ? $user->lang['ONLY_TOPIC'] : '{ ONLY_TOPIC }')); ?></b> &nbsp; <?php } ?><input class="button" type="submit" name="sort" value="<?php echo ((isset($this->_rootref['L_GO'])) ? $this->_rootref['L_GO'] : ((isset($user->lang['GO'])) ? $user->lang['GO'] : '{ GO }')); ?>" /></td>
</tr>
<tr class="toplines"> 
...
<?php $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1 pad4"><?php } else { ?><tr class="row2 pad4"><?php } ?>
		...
		<td style="padding: 4px;" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo $_postrow_val['POST_TIME']; ?></td>
		<td align="center"><input type="checkbox" class="radio" name="post_id_list[]" value="<?php echo $_postrow_val['POST_ID']; ?>" /></td>
	</tr>
<?php }} else { ?>

	<tr>
		<td class="row1 pad4" colspan="4" height="30" align="center" valign="middle"><?php if ($this->_rootref['S_TOPICS']) {  echo ((isset($this->_rootref['L_NO_TOPICS_QUEUE'])) ? $this->_rootref['L_NO_TOPICS_QUEUE'] : ((isset($user->lang['NO_TOPICS_QUEUE'])) ? $user->lang['NO_TOPICS_QUEUE'] : '{ NO_TOPICS_QUEUE }')); } else { echo ((isset($this->_rootref['L_UNAPPROVED_POSTS_ZERO_TOTAL'])) ? $this->_rootref['L_UNAPPROVED_POSTS_ZERO_TOTAL'] : ((isset($user->lang['UNAPPROVED_POSTS_ZERO_TOTAL'])) ? $user->lang['UNAPPROVED_POSTS_ZERO_TOTAL'] : '{ UNAPPROVED_POSTS_ZERO_TOTAL }')); } ?></td>
	</tr>
<?php } ?>

<tr>
	<td class="row3 pad4" colspan="4" align="center"><input class="button" type="submit" name="action[approve]" value="<?php echo ((isset($this->_rootref['L_APPROVE'])) ? $this->_rootref['L_APPROVE'] : ((isset($user->lang['APPROVE'])) ? $user->lang['APPROVE'] : '{ APPROVE }')); ?>" />&nbsp;&nbsp;<input class="button" type="submit" name="action[disapprove]" value="<?php echo ((isset($this->_rootref['L_DISAPPROVE'])) ? $this->_rootref['L_DISAPPROVE'] : ((isset($user->lang['DISAPPROVE'])) ? $user->lang['DISAPPROVE'] : '{ DISAPPROVE }')); ?>" /></td>
</tr>
</table>
