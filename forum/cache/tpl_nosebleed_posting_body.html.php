...
<tr>
	...
	<td class="row2 four" valign="top">
		...
		<tr>
			<td valign="top" style="width: 100%;"><textarea name="message" rows="25" cols="35" tabindex="3" class="post postbiggest" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onfocus="initInsertions();" style="width: 98%;"><?php echo (isset($this->_rootref['MESSAGE'])) ? $this->_rootref['MESSAGE'] : ''; ?></textarea></td>
...
<?php if ($this->_rootref['S_INLINE_ATTACHMENT_OPTIONS']) {  ?>
	...
	<tr>
		...
		<td class="row2 pad4"><select name="attachments"><?php echo (isset($this->_rootref['S_INLINE_ATTACHMENT_OPTIONS'])) ? $this->_rootref['S_INLINE_ATTACHMENT_OPTIONS'] : ''; ?></select>&nbsp;<input type="button" class="button" accesskey="a" value="<?php echo ((isset($this->_rootref['L_PLACE_INLINE'])) ? $this->_rootref['L_PLACE_INLINE'] : ((isset($user->lang['PLACE_INLINE'])) ? $user->lang['PLACE_INLINE'] : '{ PLACE_INLINE }')); ?>" name="attachinline" onclick="attach_form = document.forms[form_name].elements['attachments']; attach_inline(attach_form.value, attach_form.options[attach_form.selectedIndex].text);" onmouseover="helpline('a')" onmouseout="helpline('tip')" />
		</td>
	</tr>
<?php } ?>
